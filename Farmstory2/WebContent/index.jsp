...
<main>
    ...
    <div class="latest">
        <div>
            ...
            <table border="0">
			<c:forEach var="vo1" items="${latest1}">              
                <tr>
                    <td>></td>
                    <td><a href="/Farmstory2/board/view.do?seq=${vo1.seq}&group=croptalk&cate=grow">${vo1.title}</td>
                    <td>${vo1.rdate}</td>
                </tr>
                </c:forEach> 
            </table>
        ...
        <div>
            ...
            <table border="0">
            <c:forEach var="vo2" items="${latest2}">              
                <tr>
                    <td>></td>
                    <td><a href="/Farmstory2/board/view.do?seq=${vo2.seq}&group=croptalk&cate=school">${vo2.title}</td>
                    <td>${vo2.rdate}</td>
                </tr>
            </c:forEach> 
            </table>
        ...
        <div>
            ...
            <table border="0">
            <c:forEach var="vo3" items="${latest3}">              
                <tr>
                    <td>></td>
                    <td><a href="/Farmstory2/board/view.do?seq=${vo3.seq}&group=croptalk&cate=croptalk">${vo3.title}</td>
                    <td>${vo3.rdate}</td>
                </tr>
            </c:forEach> 
            </table>
