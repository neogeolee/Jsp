        ...
        <section id="board" class="view">
            ...
            <table>
                ...
                <tr>
                    <td>첨부파일</td>
                    <td>
                        <a href="./proc/downLoad.jsp?seq=<%= fBean.getSeq() %>&group=<%= group %>&cate=<%= cate %>"><%= fileBean.getOldName() %></a>
            ...
            <% if(mb.getUid().equals(article.getUid())) { %>
                <a href="./proc/delete.jsp?seq=<%= article.getSeq() %>&group=<%= group %>&cate=<%= cate %>" onclick="return onDelete()" class="btnDelete">삭제</a>
            ...
            <section class="commentList">
                ...
                <article class="comment">
                    ...
                    <%if(mb.getUid().equals(comment.getUid())) { %>
                        <a href="./proc/deleteComment.jsp?seq=<%=comment.getSeq() %>&parent=<%= article.getSeq() %>&group=<%= group %>&cate=<%= cate %>">삭제</a>
                        <a href="#">수정</a>
                    <% } %>
                    </div>
                </article>
